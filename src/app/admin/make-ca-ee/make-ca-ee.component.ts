...
import { CertificateEECA } from 'src/app/user/model/certificat-ee-ca';
import { ToastrService } from 'ngx-toastr';

@Component({
  selector: 'app-make-ca-ee',
  templateUrl: './make-ca-ee.component.html',
  styleUrls: ['./make-ca-ee.component.css']
})

export class MakeCaEeComponent implements OnInit {
